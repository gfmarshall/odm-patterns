...
/**
 * EligibilityResponse class - represents the output from eligibility
 * determination rules. Simple POJO design for IBM ODM as per project
 * guidelines.
 */
public class EligibilityResponse implements Serializable {
	 ...
	 *
	 * @param fundingDetermination The funding determination result
	 */
	@CustomProperty(name = "dataio.default", value = "true")
	public EligibilityResponse(@BusinessName("fundingDetermination") FundingDetermination fundingDetermination) {
