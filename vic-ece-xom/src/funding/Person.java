...
/**
 * Person class - represents a person in the Victorian ECE funding model. Simple
 * POJO design for IBM ODM as per project guidelines.
 */
public class Person implements Serializable {
	...
	public Person(@BusinessName("personId") String personId, @BusinessName("firstName") String firstName,
	...
	/**
	 * Determines if person is potentially eligible for Early Start Kindergarten
	 * (ESK)
	 * 
	 * @return true if potentially ESK-eligible based on attributes
	 */
	public boolean isPotentiallyEskEligible() {
		return indigenousStatus != IndigenousStatus.NONE || outOfHomeCareStatus
				|| immigrationStatusCodes.contains("REFUGEE") || immigrationStatusCodes.contains("ASYLUM_SEEKER");
	}
}
