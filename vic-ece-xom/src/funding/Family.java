...
public class Family implements Serializable {
	 ...
	 * @param address     The family address
	 * @param lgaCode     The local government area code
	 */
	@CustomProperty(name = "dataio.default", value = "true")
	public Family(@BusinessName("householdId") String householdId, @BusinessName("address") String address,
			@BusinessName("lgaCode") String lgaCode) {
	...
	/**
	 * Check if this family is in a disadvantaged area Based on SEIFA quintiles
	 * where lower values indicate more disadvantage
	 * 
