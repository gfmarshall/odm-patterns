...
/**
 * FundingDetermination class - represents the outcome of funding eligibility and calculation rules.
...
public class FundingDetermination implements Serializable {
    ...
    public static class EligibilityResult implements Serializable {
         ...
         */
        public EligibilityResult(String scheme, EligibilityStatus status) {
            this.scheme = scheme;
            this.status = status;
        }
    ...
    /**
     * FundingComponent inner class to represent a single component in funding calculation
     */
    public static class FundingComponent implements Serializable {
         ...
         * Constructor with fields
         */
        public FundingComponent(String componentCode, ComponentBasis basis, double quantity, double rate) {
     ...
     */
    public FundingDetermination(Child.BaseProgramType baseProgramType) {
