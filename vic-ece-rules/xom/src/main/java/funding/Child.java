...
/**
 * Child class - extends Person for the Victorian ECE funding model.
...
public class Child extends Person implements Serializable {
     ...
     */
    public Child(String personId, String firstName, String lastName, LocalDate dateOfBirth) {
    ...
    public boolean hasRefugeeOrAsylumStatus() {
        return getImmigrationStatusCodes().contains("REFUGEE") || 
               getImmigrationStatusCodes().contains("ASYLUM_SEEKER");
    }
}
