...
/**
 * EligibilityRequest class - represents the input for eligibility determination rules.
...
public class EligibilityRequest implements Serializable {
    ...
    public static class EnrolmentApplication implements Serializable {
         ...
         */
        public EnrolmentApplication(String applicationId, Child.BaseProgramType requestedBaseProgramType, int requestedWeeklyHours) {
     ...
     */
    public EligibilityRequest(int fundingYear, int programYear, Child child, Service service) {
