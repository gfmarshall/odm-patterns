...
/**
 * CalculationRequest class - represents the input for funding calculation rules.
...
public class CalculationRequest implements Serializable {
     ...
     */
    public CalculationRequest(int fundingYear, FundingDetermination eligibilityDetermination, Child child, Service service) {
